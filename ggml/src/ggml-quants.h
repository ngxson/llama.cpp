...
// Q2_K_HIFI: Q2_K with FP16 outlier protection (outlier-first quantization)
...
// =============================================================================
// K_LITE family: Q*_K + INT8 residual corrections (imatrix-driven tiered allocation)
...
// Q2_K_LITE: 84-byte Q2_K base + 3 INT8 residuals = 96 bytes total
...
// Q3_K_LITE: 110-byte Q3_K base + 8 INT8 residuals = 132 bytes total
...
// Q4_K_LITE: 144-byte Q4_K base + 8 INT8 residuals = 168 bytes total
...
// Q5_K_LITE: 176-byte Q5_K base + 8 INT8 residuals = 200 bytes total
...
// Q6_K_LITE: 210-byte Q6_K base + 8 INT8 residuals = 232 bytes total
