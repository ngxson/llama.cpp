...
// K_LITE vec_dot (Q*_K base + INT8 residual correction)
...
// K_LITE from_float wrappers (3-arg, for CPU backend registration)
...
// K_LITE generic implementations (called by arch-specific forwarding functions)
