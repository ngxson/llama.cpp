...
static constexpr __device__ vec_dot_q_cuda_t get_vec_dot_q_cuda(ggml_type type) {
    switch (type) {
        ...
        case GGML_TYPE_Q2_K_TURBO: return vec_dot_q2_k_turbo_q8_1;
        case GGML_TYPE_Q3_K_TURBO: return vec_dot_q3_k_turbo_q8_1;
        case GGML_TYPE_Q4_K_TURBO: return vec_dot_q4_k_turbo_q8_1;
        case GGML_TYPE_Q5_K_TURBO: return vec_dot_q5_k_turbo_q8_1;
        case GGML_TYPE_Q6_K_TURBO: return vec_dot_q6_k_turbo_q8_1;
...
static constexpr __device__ int get_vdr_mmvq(ggml_type type) {
    switch (type) {
        ...
        case GGML_TYPE_Q2_K_TURBO: return VDR_Q2_K_TURBO_Q8_1_MMVQ;
        case GGML_TYPE_Q3_K_TURBO: return VDR_Q3_K_TURBO_Q8_1_MMVQ;
        case GGML_TYPE_Q4_K_TURBO: return VDR_Q4_K_TURBO_Q8_1_MMVQ;
        case GGML_TYPE_Q5_K_TURBO: return VDR_Q5_K_TURBO_Q8_1_MMVQ;
        case GGML_TYPE_Q6_K_TURBO: return VDR_Q6_K_TURBO_Q8_1_MMVQ;
...
static void mul_mat_vec_q_switch_type(
    ...
    switch (type_x) {
        ...
        case GGML_TYPE_Q2_K_TURBO:
            mul_mat_vec_q_switch_ncols_dst<GGML_TYPE_Q2_K_TURBO>
                (vx, vy, ids, fusion, dst, ncols_x, nrows_x, ncols_dst, stride_row_x, stride_col_y, stride_col_dst,
                 nchannels_x, nchannels_y, nchannels_dst, stride_channel_x, stride_channel_y, stride_channel_dst,
                 nsamples_x, nsamples_dst, stride_sample_x, stride_sample_y, stride_sample_dst, ids_stride, stream);
            break;
        case GGML_TYPE_Q3_K_TURBO:
            mul_mat_vec_q_switch_ncols_dst<GGML_TYPE_Q3_K_TURBO>
                (vx, vy, ids, fusion, dst, ncols_x, nrows_x, ncols_dst, stride_row_x, stride_col_y, stride_col_dst,
                 nchannels_x, nchannels_y, nchannels_dst, stride_channel_x, stride_channel_y, stride_channel_dst,
                 nsamples_x, nsamples_dst, stride_sample_x, stride_sample_y, stride_sample_dst, ids_stride, stream);
            break;
        case GGML_TYPE_Q4_K_TURBO:
            mul_mat_vec_q_switch_ncols_dst<GGML_TYPE_Q4_K_TURBO>
                (vx, vy, ids, fusion, dst, ncols_x, nrows_x, ncols_dst, stride_row_x, stride_col_y, stride_col_dst,
                 nchannels_x, nchannels_y, nchannels_dst, stride_channel_x, stride_channel_y, stride_channel_dst,
                 nsamples_x, nsamples_dst, stride_sample_x, stride_sample_y, stride_sample_dst, ids_stride, stream);
            break;
        case GGML_TYPE_Q5_K_TURBO:
            mul_mat_vec_q_switch_ncols_dst<GGML_TYPE_Q5_K_TURBO>
                (vx, vy, ids, fusion, dst, ncols_x, nrows_x, ncols_dst, stride_row_x, stride_col_y, stride_col_dst,
                 nchannels_x, nchannels_y, nchannels_dst, stride_channel_x, stride_channel_y, stride_channel_dst,
                 nsamples_x, nsamples_dst, stride_sample_x, stride_sample_y, stride_sample_dst, ids_stride, stream);
            break;
        case GGML_TYPE_Q6_K_TURBO:
            mul_mat_vec_q_switch_ncols_dst<GGML_TYPE_Q6_K_TURBO>
                (vx, vy, ids, fusion, dst, ncols_x, nrows_x, ncols_dst, stride_row_x, stride_col_y, stride_col_dst,
                 nchannels_x, nchannels_y, nchannels_dst, stride_channel_x, stride_channel_y, stride_channel_dst,
                 nsamples_x, nsamples_dst, stride_sample_x, stride_sample_y, stride_sample_dst, ids_stride, stream);
            break;
