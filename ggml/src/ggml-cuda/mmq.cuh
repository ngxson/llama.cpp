...
static mmq_q8_1_ds_layout mmq_get_q8_1_ds_layout(const ggml_type type_x) {
    switch (type_x) {
        ...
        case GGML_TYPE_Q5_K_TURBO:  // base = Q4_K → DS4
        case GGML_TYPE_Q6_K_TURBO:  // base = Q5_K → DS4
            return MMQ_Q8_1_DS_LAYOUT_DS4;
        case GGML_TYPE_Q2_K_TURBO:  // base = Q2_K → D2S6
        case GGML_TYPE_Q3_K_TURBO:  // base = Q2_K → D2S6
            return MMQ_Q8_1_DS_LAYOUT_D2S6;
        case GGML_TYPE_Q4_K_TURBO:  // base = Q3_K → D4
        case GGML_TYPE_Q6_K:
