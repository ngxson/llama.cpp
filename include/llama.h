...
extern "C" {
    ...
    enum llama_ftype {
        ...
        LLAMA_FTYPE_MOSTLY_Q2_K_TURBO    = 48, // Q2_K + INT8 residuals (96 bytes/block, ~3.0 bpw)
        LLAMA_FTYPE_MOSTLY_Q3_K_TURBO    = 49, // Q3_K + INT8 residuals (132 bytes/block, ~4.13 bpw)
        LLAMA_FTYPE_MOSTLY_Q4_K_TURBO    = 50, // Q4_K + INT8 residuals (168 bytes/block, ~5.25 bpw)
        LLAMA_FTYPE_MOSTLY_Q5_K_TURBO    = 51, // Q5_K + INT8 residuals (200 bytes/block, ~6.25 bpw)
        LLAMA_FTYPE_MOSTLY_Q6_K_TURBO    = 52, // Q6_K + INT8 residuals (232 bytes/block, ~7.25 bpw)
