...
extern "C" {
    ...
    enum llama_ftype {
        ...
        LLAMA_FTYPE_MOSTLY_Q2_K_TURBO    = 48, // Q2_K base + INT8 residuals (96 bytes/block, ~3.0 bpw)
        LLAMA_FTYPE_MOSTLY_Q3_K_TURBO    = 49, // Q2_K base + INT8 residuals (104 bytes/block, ~3.25 bpw)
        LLAMA_FTYPE_MOSTLY_Q4_K_TURBO    = 50, // Q3_K base + INT8 residuals (128 bytes/block, ~4.0 bpw)
        LLAMA_FTYPE_MOSTLY_Q5_K_TURBO    = 51, // Q4_K base + INT8 residuals (164 bytes/block, ~5.13 bpw)
        LLAMA_FTYPE_MOSTLY_Q6_K_TURBO    = 52, // Q5_K base + INT8 residuals (196 bytes/block, ~6.13 bpw)
