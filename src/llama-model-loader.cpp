...
static std::string llama_model_ftype_name(llama_ftype ftype) {
    ...
    switch (ftype) {
        ...
        case LLAMA_FTYPE_MOSTLY_Q3_HIFI:   return "Q3_HIFI - ~4.5 bpw with 8 FP16 outliers (uniform)";
        case LLAMA_FTYPE_MOSTLY_Q3_HIFI_A: return "Q3_HIFI_A - ~4.2 bpw adaptive (Q3_HIFI on sensitive layers)";
