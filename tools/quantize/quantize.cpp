...
static const std::vector<quant_option> QUANT_OPTIONS = {
    ...
    { "Q2_K_TURBO", LLAMA_FTYPE_MOSTLY_Q2_K_TURBO, " ~3.0 bpw Q2_K + INT8 residuals (imatrix recommended)",      },
    { "Q3_K_TURBO", LLAMA_FTYPE_MOSTLY_Q3_K_TURBO, " ~4.13 bpw Q3_K + INT8 residuals (imatrix recommended)",     },
    { "Q4_K_TURBO", LLAMA_FTYPE_MOSTLY_Q4_K_TURBO, " ~5.25 bpw Q4_K + INT8 residuals (imatrix recommended)",     },
    { "Q5_K_TURBO", LLAMA_FTYPE_MOSTLY_Q5_K_TURBO, " ~6.25 bpw Q5_K + INT8 residuals (imatrix recommended)",     },
    { "Q6_K_TURBO", LLAMA_FTYPE_MOSTLY_Q6_K_TURBO, " ~7.25 bpw Q6_K + INT8 residuals (imatrix recommended)",     },
