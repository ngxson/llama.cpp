...
enum server_terminate_mode {
    SERVER_TERMINATE_MODE_NONE,
    SERVER_TERMINATE_MODE_IMMEDIATE, // skip all pending tasks and terminate immediately
    SERVER_TERMINATE_MODE_IDLE,      // wait until all tasks are completed and terminate when idle
};
...
struct common_params {
    ...
    server_terminate_mode terminate_mode = SERVER_TERMINATE_MODE_IMMEDIATE;
