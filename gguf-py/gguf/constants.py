...
MODEL_ARCH_NAMES: dict[MODEL_ARCH, str] = {
    ...
    MODEL_ARCH.DEEPSEEK_V4_FLASH: "deepseek-v4-flash",
...
TENSOR_NAMES: dict[MODEL_TENSOR, str] = {
    ...
    MODEL_TENSOR.HC_HEAD_FN:                "output_hc.fn",
    MODEL_TENSOR.HC_HEAD_BASE:              "output_hc.base",
    MODEL_TENSOR.HC_HEAD_SCALE:             "output_hc.scale",
    ...
    MODEL_TENSOR.ATTN_COMPRESSOR_WKV:        "blk.{bid}.attn_comp.wkv",
    MODEL_TENSOR.ATTN_COMPRESSOR_WGATE:      "blk.{bid}.attn_comp.wgate",
    MODEL_TENSOR.ATTN_COMPRESSOR_APE:        "blk.{bid}.attn_comp.ape",
    MODEL_TENSOR.ATTN_COMPRESSOR_NORM:       "blk.{bid}.attn_comp.norm",
    ...
    MODEL_TENSOR.INDEXER_COMPRESSOR_WKV:     "blk.{bid}.indexer_comp.wkv",
    MODEL_TENSOR.INDEXER_COMPRESSOR_WGATE:   "blk.{bid}.indexer_comp.wgate",
    MODEL_TENSOR.INDEXER_COMPRESSOR_APE:     "blk.{bid}.indexer_comp.ape",
    MODEL_TENSOR.INDEXER_COMPRESSOR_NORM:    "blk.{bid}.indexer_comp.norm",
    # vision
